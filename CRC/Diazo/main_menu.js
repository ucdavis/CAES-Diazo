$(document).ready(function() {
    ...
    var queryInFocus = false;

    // set up event handlers to keep main nav open when search is in focus
    // $('#search_field #search_text, #search_controls .inputsubmit,#search_options a,#search_plus a').bind({
    $('#search *, #search_plus *').bind({
        focus: function() {
            queryInFocus = true;
